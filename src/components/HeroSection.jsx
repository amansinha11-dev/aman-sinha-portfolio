  ...
  return (
   ...
   lg:px-24 px-10 relative overflow-hidden">
    ...
    <div className="z-40 xl:mb-0 mb[20%]">
      ...
      >
        Delivering robust, production-ready websites and web applications with speed and precision, each project is underpinned by a disciplined approach honed through C++ data structures and algorithms, alongside proficiency in Python, Java, the MERN stack, and data analytics/AI-ML.
      </motion.p>
      </div> 
      {/*Right Section*/}
       <Spline
