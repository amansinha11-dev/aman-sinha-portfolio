...
import { useRef, useEffects, use } from "react";
import { gsap } from "gsap";
import { useEffect } from "react";

const CustomCursor = () => {
    //Refrence for cursor element
    ...
    useEffect(() => {
      ...
      //inital position off-screen
      gsap.set([cursor, cursorBorder], {
        xPercent: -50,
        yPercent: -50,

      })
      // varibles for cursor position wiith diffrent speeds
...
document.addEventListener("mouseup", () => {
  ...
  <>
     ...
     <dev 
      ...
      mix-blend-diffrence opacity-50"/>
  </>
  )
}
